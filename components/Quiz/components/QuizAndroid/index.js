...
class QuizAndroid extends Component {
  state = {
    show: screen.QUESTION,
    correct: 0,
    incorrect: 0,
    questionCount: this.props.deck(this.props.title).questions.length,
    answered: Array(this.props.deck(this.props.title).questions.length).fill(0),
  };
  ...
  render() {
    const { questions } = this.props.deck(this.props.title);
    const { show } = this.state;
    console.log("am here now", this.props);
